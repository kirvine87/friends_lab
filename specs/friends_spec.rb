...
class TestFriends < MiniTest::Test
  ...
  def test_lend_monies
    result = lend_monies(@person5, @person1, 10)
    assert_equal(11 && 90, result)
  end
# test to check if lender has enough monies.
  def test_lend_monies_able
    result = lend_monies(@person1, @person5, 10)
    assert_equal("Not enough monies.", result)
  end
